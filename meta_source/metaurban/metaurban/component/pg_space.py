...
class VehicleParameterSpace:
    ...
    ROBOT_ = dict(
        wheel_friction=ConstantSpace(1.0),
        max_engine_force=BoxSpace(350, 550),
        max_brake_force=BoxSpace(35, 80),
        max_steering=ConstantSpace(30),
...
class BlockParameterSpace:
    ...
    # CURVE = {
    #     Parameter.length: BoxSpace(min=50.0, max=90.0),
    #     Parameter.radius: BoxSpace(min=55.0, max=80.0),
    #     Parameter.angle: BoxSpace(min=45, max=135),
    #     Parameter.dir: DiscreteSpace(min=0, max=1)
    # }
    # INTERSECTION = {
    #     Parameter.radius: ConstantSpace(20),
    ...
    # ROUNDABOUT = {
    #     # The radius of the
    #     Parameter.radius_exit: BoxSpace(min=35, max=45),
    #     Parameter.radius_inner: BoxSpace(min=45, max=65),
    #     Parameter.angle: ConstantSpace(60)
    # }
    # T_INTERSECTION = {
    #     Parameter.radius: ConstantSpace(50),
    ...
    #     Parameter.radius: ConstantSpace(value=54),
    ...
    INTERSECTION = {
        Parameter.radius: ConstantSpace(40),
        Parameter.change_lane_num: DiscreteSpace(min=0, max=1),  # 0, 1
        Parameter.decrease_increase: DiscreteSpace(min=0, max=1)  # 0, decrease, 1 increase
        # Parameter.decrease_increase: DiscreteSpace(min=1, max=1)  # 0, decrease, 1 increase
    }
