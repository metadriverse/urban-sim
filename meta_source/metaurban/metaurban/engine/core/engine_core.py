...
import gltf
from metaurban.third_party.simplepbr import init
...
from metaurban.constants import RENDER_MODE_OFFSCREEN, RENDER_MODE_NONE, RENDER_MODE_ONSCREEN, EDITION, CamMask, \
    BKG_COLOR
from metaurban.engine.asset_loader import initialize_asset_loader, close_asset_loader, randomize_cover, get_logo_file
from metaurban.engine.core.collision_callback import collision_callback
from metaurban.engine.core.draw import ColorLineNodePath, ColorSphereNodePath
from metaurban.engine.core.force_fps import ForceFPS
from metaurban.engine.core.image_buffer import ImageBuffer
from metaurban.engine.core.light import Light
...
from metaurban.engine.core.pssm import PSSM
from metaurban.engine.core.sky_box import SkyBox
from metaurban.engine.core.terrain import Terrain
from metaurban.engine.logger import get_logger
from metaurban.utils.utils import is_mac, setup_logger
import logging
import subprocess
...
class EngineCore(ShowBase.ShowBase):
    ...
    def __init__(self, global_config):
        ...
        if 'sensors' not in global_config:
        ...
        elif "main_camera" not in global_config["sensors"]:
            # reduce size as we don't use the main camera content for improving efficiency
            config["window_size"] = (1, 1)
            self.main_window_disabled = True
        ...
        try:
            if self.use_render_pipeline:
                from metaurban.render_pipeline.rpcore import RenderPipeline
                from metaurban.render_pipeline.rpcore.rpobject import RPObject
