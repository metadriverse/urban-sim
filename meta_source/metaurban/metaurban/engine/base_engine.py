...
from metaurban.base_class.randomizable import Randomizable
from metaurban.constants import RENDER_MODE_NONE
from metaurban.engine.core.engine_core import EngineCore
from metaurban.engine.interface import Interface
from metaurban.engine.logger import get_logger, reset_logger

from metaurban.pull_asset import pull_asset
from metaurban.utils import concat_step_infos
from metaurban.utils.utils import is_map_related_class
from metaurban.version import VERSION, asset_version
...
class BaseEngine(EngineCore, Randomizable):
    ...
    def __init__(self, global_config):
        ...
        # managers
        self.task_manager = self.taskMgr  # use the inner TaskMgr of Panda3D as MetaUrban task manager
    ...
    def setup_main_camera(self):
        from metaurban.engine.core.main_camera import MainCamera
    ...
    def warmup(self):
        ...
        if self.global_config["preload_models"] and self.mode != RENDER_MODE_NONE:
            ...
            from metaurban.component.static_object.traffic_object import TrafficBarrier
            from metaurban.component.static_object.traffic_object import TrafficCone
