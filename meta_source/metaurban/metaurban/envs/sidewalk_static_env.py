...
class SidewalkStaticMetaUrbanEnv(BaseEnv):
    ...
    def default_config(cls) -> Config:
        config = super(SidewalkStaticMetaUrbanEnv, cls).default_config()
    ...
    def __init__(self, config: Union[dict, None] = None):
        ...
        super(SidewalkStaticMetaUrbanEnv, self).__init__(config)
    ...
    def _post_process_config(self, config):
        config = super(SidewalkStaticMetaUrbanEnv, self)._post_process_config(config)
    ...
    def setup_engine(self):
        super(SidewalkStaticMetaUrbanEnv, self).setup_engine()
        from metaurban.manager.traffic_manager import PGTrafficManager
