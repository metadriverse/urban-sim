...
if setting_name == 'general':
    ...
    class CommandsCfg:
        ...
        pose_command = nav_mdp.UniformPose2dCommandCfg(
            ...
            debug_vis=True,
            ranges=nav_mdp.UniformPose2dCommandCfg.Ranges(pos_x=(10.0, 20.0), pos_y=(10.0, 20.0), heading=(-math.pi, math.pi)),
        )
...
class ViewerCfg:
    ...
    eye: tuple[float, float, float] = (-5, -5, 7) 
...
gym.register(
    ...
    kwargs={
        ...
        "rl_games_cfg_entry_point": f"configs/rl_configs/{task_name}/{robot_name}/{setting_name}_play.yaml",
    },
)
...
def train_with_rlgames():
    ...
    runner.reset()
    # train the agent
    runner.run({"train": False, "play": True, "sigma": None, "checkpoint": args_cli.checkpoint})
