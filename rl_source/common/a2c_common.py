...
class A2CBase(BaseAlgorithm):
    ...
    def init_tensors(self):
        ...
        if 'sensor_observation_space' in self.env_info:
            if self.env_info['sensor_observation_space']:
                env_info['observation_space'] = gym.spaces.Dict({'obs_addons': self.env_info['observation_space'], 'obs_sensor': self.env_info['sensor_observation_space']})
